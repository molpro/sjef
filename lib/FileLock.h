...
public:
   ...
   * @param exclusive Whether to have sole access (as needed if the file is to be written), or shared access (for
   * example, just for reading the file). Note that shared access between threads in the same process is not implemented
   * - all such accesses are mutually exclusive.
